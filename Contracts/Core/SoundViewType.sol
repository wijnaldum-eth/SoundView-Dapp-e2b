...
import { ISoundMarketType, TypeInfo } from "./interfaces/ISoundMarketType.sol";
...
/**
 * @title SoundMarketType
 * @notice The Sound Market Type contract - a creator-owned, modifiable implementation of ERC721A.
 */
contract SoundMarketType is
    ISoundMarketType,
    ...
    OperatorFilterer
{
    ...
    function initialize(
        ...
        emit SoundMarketTypeInitialized(
            address(this),
            name_,
            symbol_,
            metadataModule_,
    ...
    /**
     * @inheritdoc ISoundSoundMarketType
     */
    ...
    function supportsInterface(bytes4 interfaceId)
        public
        view
        override(ISoundMarketType, ERC721AUpgradeable, IERC721AUpgradeable)
        returns (bool)
    {
        return
            interfaceId == _INTERFACE_ID_SOUND_MarketType_V1 ||
            interfaceId == type(ISoundMarketType).interfaceId ||
